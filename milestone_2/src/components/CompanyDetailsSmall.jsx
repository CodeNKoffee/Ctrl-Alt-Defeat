...
export default function CompanyDetailsSmall({ version, companyName, companyEmail, companyLogo, industry, size, documentation, onExpand }) {
  return (
        ...
        <div className="company-content">
          ...
          <div className="row-three">
            ...
            <div className="verdict">
              <button className="accept" onClick={onExpand}>View Details</button>
