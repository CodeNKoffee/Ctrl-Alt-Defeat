            ...
            <div className="bg-gradient-to-r from-[#EBF7FA] to-[#F7FBFD] p-4 rounded-xl border border-[#D9F0F4] mb-4 text-gray-700">
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <span className="rtl:text-right">Track accepted, rejected, and flagged reports per internship cycle</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#3298BA] mr-2 rtl:ml-2 rtl:mr-0">✓</span>
                  <span className="rtl:text-right">Monitor average review time across faculty</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#3298BA] mr-2 rtl:ml-2 rtl:mr-0">✓</span>
                  <span className="rtl:text-right">View top courses most used in internships</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#3298BA] mr-2 rtl:ml-2 rtl:mr-0">✓</span>
                  <span className="rtl:text-right">Discover top-rated companies based on student evaluations</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#3298BA] mr-2 rtl:ml-2 rtl:mr-0">✓</span>
                  <span className="rtl:text-right">Identify companies with highest internship participation</span>
                </li>
              </ul>
            </div>

            <div className="bg-[#D9F0F4] text-metallica-blue-700 font-medium px-4 py-2 rounded-lg border-l-4 border-[#5DB2C7] shadow-sm w-fit rtl:text-right">
