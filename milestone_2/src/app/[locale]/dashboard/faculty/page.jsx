          ...
          <div className="text-left rtl:text-right w-full">
            ...
            <div className="bg-gradient-to-r from-[#EBF7FA] to-[#F7FBFD] p-4 rounded-xl border border-[#D9F0F4] mb-4 text-gray-700">
              <ul className="space-y-2">
                <li className="flex items-start">
                  <span className="text-[#3298BA] mr-2 rtl:ml-2 rtl:mr-0">✓</span>
                  <span className="rtl:text-right">{safeT('faculty.dashboard.statistics.features.trackReports')}</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#3298BA] mr-2 rtl:ml-2 rtl:mr-0">✓</span>
                  <span className="rtl:text-right">{safeT('faculty.dashboard.statistics.features.monitorReviewTime')}</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#3298BA] mr-2 rtl:ml-2 rtl:mr-0">✓</span>
                  <span className="rtl:text-right">{safeT('faculty.dashboard.statistics.features.viewTopCourses')}</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#3298BA] mr-2 rtl:ml-2 rtl:mr-0">✓</span>
                  <span className="rtl:text-right">{safeT('faculty.dashboard.statistics.features.discoverTopCompanies')}</span>
                </li>
                <li className="flex items-start">
                  <span className="text-[#3298BA] mr-2 rtl:ml-2 rtl:mr-0">✓</span>
                  <span className="rtl:text-right">{safeT('faculty.dashboard.statistics.features.identifyParticipation')}</span>
                </li>
              </ul>
            </div>
